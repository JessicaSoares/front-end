     ...
     <Search details={initialDetails} />{/*Módulo de filtro de busca*/}
      ...
      <section class="page-section-sub-boxlegend " id="about">
        <Container>
          ...
          <ListarPaineis details={initialDetails} props="meioambienteMaps" /> {/*Módulo que trás o mapa correspondente a categoria da página (props define a categoria)*/}
        </Container>
      </section>
