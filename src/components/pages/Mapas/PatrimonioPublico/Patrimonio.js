...
export default function Urbanismo() {
  ...
  return (
    <>
      ...
      <TextSectionItem
        titlesection="Patrimônio público"
      ...
      <section class="page-section-sub-boxlegend " id="about">
        <Container>
          ...
          <ListarPaineis details={initialDetails} props="patrimonioMaps" /> {/*Módulo que trás o mapa correspondente a categoria da página (props define a categoria)*/}
        </Container>
      </section>
