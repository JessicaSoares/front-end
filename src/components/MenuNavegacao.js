...
{/* Menu de navegação do topo do portal */ }
function MenuNavegacao() {
  ...
  return (
    <>
      {/* Menus com direcionamento para outras áreas do portal  */}
      <nav className='navbar'>
        ...
        <ul className={click ? 'nav-menu active' : 'nav-menu'}>
          <li className='nav-item'>
            <Link refresh="true" to='/' className='nav-links' onClick={() => { window.location.href = "/" }}>
              Início
            </Link>
          </li>
          ...
          <ul className={boxClass.join(' ')}>
            ...
            <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> Indicadores &nbsp;<FiChevronDown /> </Link>
              <ul className={boxClassSubMenu.join(' ')}>
                ...
                <li><NavLink onClick={closeMobileMenu} activeClassName='is-active' to={`/Turismo`}> Turismo </NavLink> </li>
              </ul>
            </li>
