...
{/* Cards de mais acessados na pagina inicial*/}
function Cards() {
  return (
    <div className="cards">
      ...
      <div className="cards__container">
        <div className="cards__wrapper">
          <ul className="cards__items">
            ...
            src="https://img.icons8.com/dotty/80/4a90e2/exchange.png"
              label="Economia"
              path="/economia"
            />{/* Componente card que recebe link do ícone, nome de label e link de redireconamento*/}
            <CardItem
          src="https://img.icons8.com/dotty/80/4a90e2/graduation-cap.png"
              text=""
              label="Educação"
              path="/Social"
            />
        ...
        <div className="cards__wrapper">
          ...
          <CardItemgov
           src="https://img.icons8.com/dotty/80/26e07f/plumbing.png"
            ...
            />
            <CardItemgov
      src="https://img.icons8.com/dotty/80/26e07f/windmill.png"
              text=""
              label="Agropecuária"
